...
before persisting. 裁决： COMPLETE (sprint generated and written) or
...
### 用例 1: Happy Path — Backlog with stories generates sprint
...
### 用例 2: Blocked Path — Backlog is empty
...
### 用例 3: Gate returns CONCERNS — Sprint overloaded, revised before write
...
### 用例 4: Lean Mode — PR-SPRINT gate skipped
...
### 用例 5: Edge Case — Previous sprint still has open stories
