...
无。 Retrospectives are team self-reflection documents; no gates are invoked.

---

## 测试用例

### 用例 1: Happy Path — Sprint with mixed outcomes
...
### 用例 2: No Sprint Data — Manual input fallback
...
### 用例 3: Prior Retrospective Exists — Offer to append or replace
...
### 用例 4: Edge Case — Unresolved action items from previous retrospective
...
### 用例 5: Gate Compliance — No gate invoked in any mode
