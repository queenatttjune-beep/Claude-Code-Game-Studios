...
### 用例 1: Happy Path — Two approved GDDs create two EPIC files
...
### 用例 2: Failure Path — No approved GDDs found
...
### 用例 3: Director Gate — Full mode spawns PR-EPIC before writing
...
### 用例 4: Edge Case — Epic already exists for a GDD
...
### 用例 5: Director Gate — PR-EPIC returns CONCERNS
