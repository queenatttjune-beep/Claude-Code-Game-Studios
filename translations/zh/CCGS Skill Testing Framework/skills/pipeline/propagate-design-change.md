# Skill 测试 Spec: /propagate-design-change
...
### 用例 1: Happy Path — GDD revision affects 2 stories and 1 epic
...
### 用例 2: No Impact — Changed GDD has no downstream references
...
### 用例 3: In-Progress Story Warning — Referenced story is currently being developed
...
**输入：** `/propagate-design-change` (no argument)
...
### 用例 5: Director Gate — No gate spawned regardless of review mode
