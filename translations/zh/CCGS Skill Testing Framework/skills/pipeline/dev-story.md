...
### 用例 1: Happy Path — Story implemented and marked Complete (full mode)
...
### 用例 2: Failure Path — Referenced ADR is Proposed
...
### 用例 3: Ambiguous Acceptance Criteria — Skill asks for clarification
...
### 用例 4: Edge Case — No argument; reads from session state
...
### 用例 5: Director Gate — LP-CODE-REVIEW returns NEEDS CHANGES; lean mode skips gate
