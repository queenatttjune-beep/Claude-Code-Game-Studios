...
### 用例 1: Happy Path — Game concept exists, 5-8 systems identified
...
### 用例 2: Failure Path — No game concept found
...
### 用例 3: Director Gate — CD-SYSTEMS returns CONCERNS (missing core system)
...
### 用例 4: Edge Case — systems-index.md already exists
...
### 用例 5: Director Gate — Lean mode and solo mode both skip gates, noted
