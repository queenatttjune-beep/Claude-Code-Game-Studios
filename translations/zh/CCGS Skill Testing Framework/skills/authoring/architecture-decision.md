# Skill 测试 Spec: /architecture-decision
...
### 用例 1: Happy Path — New ADR for rendering approach, full mode, gates approve
...
### 用例 2: Failure Path — TD-ADR returns CONCERNS
...
### 用例 3: Lean Mode — Both gates skipped; ADR written as Proposed
...
### 用例 4: Edge Case — ADR already exists for this topic
...
### 用例 5: Director Gate — Status set correctly based on mode and gate outcome
