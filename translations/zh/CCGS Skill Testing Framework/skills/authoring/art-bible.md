...
### 用例 1: Happy Path — Full mode, art bible drafted, AD-ART-BIBLE approves
...
### 用例 2: AD-ART-BIBLE Returns CONCERNS — Section revised before writing
...
### 用例 3: Lean Mode — AD-ART-BIBLE Skipped, Written With User Approval Only
...
### 用例 4: Existing Art Bible — Retrofit Mode
...
### 用例 5: Solo Mode — AD-ART-BIBLE Skipped, Noted in Output
