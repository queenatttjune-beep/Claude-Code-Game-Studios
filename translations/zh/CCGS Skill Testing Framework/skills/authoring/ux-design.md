...
无。 `/ux-design` has no inline director gates. `/ux-review` is the separate
...
### 用例 1: Happy Path — New HUD spec, all sections authored and written
...
### 用例 2: Existing UX Spec — Retrofit: user picks section to update
...
### 用例 3: Dependency Gap — Spec references a system with no design doc
...
### 用例 4: No Argument Provided — Usage error
...
### 用例 5: Director Gate Check — No gate; ux-review is the separate review skill
