...
### 用例 1: Happy Path — New GDD, skeleton-first, CD-GDD-ALIGN in lean mode
...
### 用例 2: Retrofit Mode — Existing GDD, update specific section
...
### 用例 3: Director Gate — CD-GDD-ALIGN returns MAJOR REVISION
...
### 用例 4: Solo Mode — CD-GDD-ALIGN skipped; sections written with user approval only
...
### 用例 5: Director Gate — Empty sections not written to file
