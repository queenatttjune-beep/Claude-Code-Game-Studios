# Skill 测试 Spec: /create-architecture
...
### 用例 1: Happy Path — New architecture doc, skeleton-first, full mode gates approve
...
### 用例 2: Failure Path — TD-ARCHITECTURE returns MAJOR REVISION
...
### 用例 3: Lean Mode — Both gates skipped; architecture written with user approval only
...
### 用例 4: Retrofit Mode — Existing architecture doc, user updates a section
...
### 用例 5: Director Gate — Architecture references a Proposed ADR; flagged as risk
