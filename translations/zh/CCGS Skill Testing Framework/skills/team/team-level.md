...
### 用例 1: Happy Path — All team members produce outputs, document compiled and saved
...
### 用例 2: Blocked Agent (world-builder) — Partial report produced with gap noted
...
### 用例 4: Accessibility Review Gate — Blocking concern surfaces before sign-off
...
### 用例 5: Circular Level Reference — Adjacent area dependency flagged
