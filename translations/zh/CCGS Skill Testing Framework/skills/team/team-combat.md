...
### 用例 1: Happy Path — All agents succeed, full pipeline runs to completion
...
### 用例 2: Blocked Agent — One subagent returns BLOCKED mid-pipeline
...
### 用例 3: No Argument — Clear usage guidance shown

**设置：**
- Any project state

**输入：** `/team-combat` (no argument)
...
### 用例 4: Parallel Phase Validation — Phase 3 agents run simultaneously
...
**输入：** `/team-combat parry and riposte system` (resuming from Phase 2 complete)
...
### 用例 5: Architecture Phase Engine Routing — Engine specialist receives correct context
