...
### 用例 1: Happy Path — All 7 phases complete, season plan produced
...
### 用例 2: Ethics Violation Found — Reward element violates ethics policy
...
### 用例 4: Parallel Phase Validation — Phases 3 and 4 run simultaneously
...
**输入：** `/team-live-ops "Season 1: The First Thaw"` (observed at Phase 3/4 transition)
...
### 用例 5: Missing Ethics Policy — `design/live-ops/ethics-policy.md` does not exist
