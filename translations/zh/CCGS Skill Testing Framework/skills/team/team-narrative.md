...
### 用例 1: Happy Path — All five phases complete, narrative doc delivered
...
### 用例 2: Lore Contradiction Found — world-builder finds conflict before writer proceeds
...
### 用例 3: No Argument — Usage guidance shown

**设置：**
- Any project state

**输入：** `/team-narrative` (no argument)
...
### 用例 4: Localization Compliance — localization-lead flags a non-translatable string
...
**输入：** `/team-narrative ironveil faction introduction cutscene` (Phase 5 scenario)
...
### 用例 5: Writer Blocked — Missing character voice profiles
