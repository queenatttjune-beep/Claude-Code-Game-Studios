...
### 用例 1: Happy Path (Single-Player) — All phases complete, version deployed
...
### 用例 2: Go/No-Go: NO — S1 bug found in Phase 3, deployment skipped
...
### 用例 3: Security Audit for Online Game — security-engineer is spawned in Phase 3
...
### 用例 4: Localization Miss — Untranslated strings block the ship
...
### 用例 5: No Argument — Skill infers version or asks
