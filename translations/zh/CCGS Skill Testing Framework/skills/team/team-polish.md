...
### 用例 1: Happy Path — Full pipeline completes, READY FOR RELEASE verdict
...
### 用例 2: Performance Blocker — Frame budget violation cannot be fully resolved
...
### 用例 4: Engine-Level Bottleneck — engine-programmer spawned conditionally in Phase 2
...
### 用例 5: Regression Found — Polish change broke an existing feature
...
**输入：** `/team-polish inventory-ui` (Phase 5 scenario)
