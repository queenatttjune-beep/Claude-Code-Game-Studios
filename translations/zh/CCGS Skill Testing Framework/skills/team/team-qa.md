...
### 用例 1: Happy Path — All stories pass manual QA, APPROVED verdict
...
### 用例 2: Smoke Check Fail — QA cycle stops at Phase 4
...
### 用例 3: Bug Found — Visual/Feel story fails manual QA, bug report filed
...
### 用例 4: No Argument — Skill infers active sprint or asks user
...
### 用例 5: Mixed Results — Some PASS, one FAIL with S1 bug, one BLOCKED
