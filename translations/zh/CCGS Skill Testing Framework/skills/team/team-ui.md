...
### 用例 1: Happy Path — Full pipeline from UX spec through polish succeeds
...
### 用例 2: UX Review Gate — Spec fails review; skill halts before implementation
...
### 用例 4: Accessibility Parallel Review — Phase 4 runs three streams simultaneously
...
**输入：** `/team-ui inventory screen` (resuming from Phase 3 complete)
...
### 用例 5: Missing Interaction Pattern Library — Skill notes the gap rather than inventing patterns
