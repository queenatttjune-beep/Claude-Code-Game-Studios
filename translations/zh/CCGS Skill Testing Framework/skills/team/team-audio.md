...
### 用例 1: Happy Path — All steps complete, audio design document saved
...
### 用例 2: Accessibility Gap — Critical gameplay audio event has no visual fallback
...
**输入：** `/team-audio stealth` (Step 2 scenario)
...
### 用例 3: No Argument — Usage guidance or design doc inference

**设置：**
- Any project state

**输入：** `/team-audio` (no argument)
...
### 用例 4: Missing Sound Bible — Skill notes the gap and proceeds without it
...
### 用例 5: Engine Not Configured — Engine specialist step skipped gracefully
