...
裁决： ON SCOPE, CONCERNS, or SCOPE CREEP DETECTED.
...
无。 Scope check is a read-only advisory skill; no gates are invoked.

---

## 测试用例

### 用例 1: Happy Path — Sprint stories align with milestone goals
...
### 用例 2: Scope Creep Detected — Stories introducing systems not in milestone
...
### 用例 3: No Milestone Defined — CONCERNS; scope cannot be validated
...
### 用例 4: Single Story Check — Evaluated against its parent epic
...
### 用例 5: Gate Compliance — No gate; PR may be consulted separately
