...
are invoked. The skill does not write without user approval. 裁决： COMPLIANT,
...
无。 Asset auditing is a read-only analysis skill; no gates are invoked.

---

## 测试用例

### 用例 1: Happy Path — All assets follow naming conventions
...
### 用例 2: Non-Compliant — Textures exceed size budget
...
### 用例 3: Format Issue — Audio in wrong format
...
### 用例 4: Missing Asset — Asset referenced by GDD but absent from assets/
...
### 用例 5: Gate Compliance — No gate; technical-artist may be consulted separately
