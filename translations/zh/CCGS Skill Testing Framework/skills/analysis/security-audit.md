...
write files (findings report only). 裁决： SECURE, CONCERNS, or
...
无。 Security audit is a read-only advisory skill; no gates are invoked.

---

## 测试用例

### 用例 1: Happy Path — Save data encrypted, no hardcoded credentials
...
### 用例 2: Vulnerabilities Found — Unencrypted save data and exposed version
...
### 用例 3: Online Features Without Authentication — CONCERNS
...
### 用例 4: Edge Case — No Source Files to Analyze
...
### 用例 5: Gate Compliance — No gate; security-engineer invoked separately
