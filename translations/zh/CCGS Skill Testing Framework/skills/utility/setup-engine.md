...
无。 `/setup-engine` is a technical configuration skill. No director gates apply.

---

## 测试用例

### 用例 1: Godot 4 + GDScript — Full engine configuration
...
### 用例 2: Unity + C# — Unity-specific configuration
...
### 用例 3: Unreal + Blueprint — Unreal-specific configuration
...
### 用例 4: Engine Already Configured — Offers to reconfigure specific sections
...
### 用例 5: Director Gate Check — No gate; setup-engine is a utility skill
