...
无。 `/skill-test` is a meta-utility skill. No director gates apply.

---

## 测试用例

### 用例 1: Static Mode — Well-formed skill, all 7 checks pass, COMPLIANT
...
### 用例 2: Static Mode — Skill Missing "May I Write" Despite Write Tool in allowed-tools
...
### 用例 3: Spec Mode — gate-check Skill Evaluated Against Spec
...
### 用例 4: Audit Mode — Coverage Table of All Skills and Agents
...
### 用例 5: Category Mode — Gate Skill Evaluated Against Quality Rubric
