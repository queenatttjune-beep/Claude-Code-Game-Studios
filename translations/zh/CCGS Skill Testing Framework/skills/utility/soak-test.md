...
无。 `/soak-test` is a QA planning utility. No director gates apply.

---

## 测试用例

### 用例 1: Happy Path — Online gameplay feature, 2-hour soak protocol
...
### 用例 2: No Target Defined — Prompts for system, duration, and conditions
...
### 用例 3: Previous Soak Test Exists — Offers to extend or add conditions
...
### 用例 4: Mobile Target Platform — Memory-specific checkpoints added
...
### 用例 5: Director Gate Check — No gate; soak-test is a planning utility
