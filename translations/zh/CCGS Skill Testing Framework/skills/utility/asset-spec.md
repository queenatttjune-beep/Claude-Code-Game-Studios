...
无。 `/asset-spec` is a design documentation utility. Technical artists may
...
### 用例 1: Happy Path — Enemy sprite spec with full GDD and art bible
...
### 用例 2: No Art Bible Found — Spec with Placeholder Style Notes, Dependency Flagged
...
### 用例 3: Asset Spec Already Exists — Offers to Update
...
### 用例 4: Multiple Assets Requested — May-I-Write Per Asset
...
### 用例 5: Director Gate Check — No gate; asset-spec is a design utility
