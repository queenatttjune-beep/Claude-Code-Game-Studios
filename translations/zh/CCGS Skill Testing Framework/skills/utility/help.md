...
无。 `/help` is a read-only navigation skill. No director gates apply.

---

## 测试用例

### 用例 1: Happy Path — Production stage with active sprint
...
### 用例 2: Concept Stage — Shows concept-to-systems-design workflow path
...
### 用例 3: No stage.txt — Shows full workflow overview
...
### 用例 4: Context Query — User asks for help with testing
...
### 用例 5: Director Gate Check — No gate; help is read-only navigation
