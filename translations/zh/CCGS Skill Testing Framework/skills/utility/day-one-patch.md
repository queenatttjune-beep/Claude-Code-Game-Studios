...
无。 `/day-one-patch` is a release planning utility. No director gates apply.

---

## 测试用例

### 用例 1: Happy Path — 3 Known Issues, Patch Plan With Fix Estimates
...
### 用例 2: Critical Issue Discovered Post-Ship — P0, Triggers /hotfix Guidance
...
### 用例 3: Deferred AC From Story-Done — Pulled Into Patch Plan Automatically
...
### 用例 4: No Known Issues — Empty Plan With Template Note
...
### 用例 5: Director Gate Check — No gate; day-one-patch is a planning utility
