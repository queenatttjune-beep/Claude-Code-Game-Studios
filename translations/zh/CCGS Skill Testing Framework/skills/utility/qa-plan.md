...
无。 `/qa-plan` is a planning utility. Story readiness gates are separate.

---

## 测试用例

### 用例 1: Happy Path — Sprint with 4 stories generates full test plan
...
### 用例 2: Story With No Acceptance Criteria — Flagged as UNTESTABLE
...
### 用例 3: Existing Test Plan Found — Offers update rather than replace
...
### 用例 4: No Stories Found for Sprint — Error with guidance
...
### 用例 5: Director Gate Check — No gate; QA planning is a utility
