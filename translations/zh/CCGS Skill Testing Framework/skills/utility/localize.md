...
裁决： LOCALIZATION COMPLETE (all locales are complete) or GAPS FOUND (at
...
无。 `/localize` is a pipeline utility. No director gates apply. Localization
...
### 用例 1: New Language — String Extraction and Locale Skeleton Created
...
### 用例 2: Existing Locale Diff — Additions, Removals, and Changes Listed
...
### 用例 3: String Missing in One Locale — GAPS FOUND With Missing Key List
...
### 用例 4: Translation File Has Syntax Error — Error With Line Reference
...
### 用例 5: Director Gate Check — No gate; localization is a pipeline utility
