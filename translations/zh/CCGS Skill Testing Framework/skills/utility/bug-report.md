...
无。 `/bug-report` is an operational documentation skill. No director gates apply.

---

## 测试用例

### 用例 1: Happy Path — User describes a crash, full report produced

**设置：**
- `production/bugs/` directory exists and is empty
- No similar existing reports

**输入：** `/bug-report` (user describes: "Game crashes when player enters the boss arena")
...
### 用例 2: Minimal Input — Skill asks follow-up questions for missing fields
...
### 用例 3: Possible Duplicate — Offers to link rather than create new

**设置：**
- `production/bugs/bug-2026-03-20-audio-cut-out.md` already exists with
  similar title and MEDIUM severity

**输入：** `/bug-report` (user describes: "Audio randomly stops working")
...
### 用例 4: Multi-System Bug — Report created with multiple system tags

**设置：**
- No existing reports

**输入：** `/bug-report` (user describes: "After finishing a level, the save system
...
### 用例 5: Director Gate Check — No gate; bug reporting is operational
