...
无。 `/adopt` is a brownfield audit utility. No director gates apply.

---

## 测试用例

### 用例 1: Happy Path — All GDDs compliant, no gaps, COMPLIANT
...
### 用例 2: Non-Compliant Documents — GDDs missing sections, NEEDS MIGRATION
...
### 用例 3: Mixed State — Some docs compliant, some not, partial report
...
### 用例 4: No Artifacts Found — Fresh project, guidance to run /start
...
### 用例 5: Director Gate Check — No gate; adopt is a utility audit skill
