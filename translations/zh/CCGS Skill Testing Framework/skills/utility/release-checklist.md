# Skill 测试 Spec: /release-checklist
...
formal phase gate logic. 裁决： RELEASE READY, RELEASE BLOCKED, or CONCERNS.
...
无。 `/release-checklist` is an internal audit utility. Formal phase advancement
...
### 用例 1: Happy Path — All Sprint Stories Complete, QA Passed, RELEASE READY
...
### 用例 2: Open HIGH Severity Bugs — RELEASE BLOCKED
...
### 用例 3: Changelog Not Generated — CONCERNS
...
### 用例 4: Previous Release Checklist Exists — Delta From Last Release
...
### 用例 5: Director Gate Check — No gate; release-checklist is an internal audit
