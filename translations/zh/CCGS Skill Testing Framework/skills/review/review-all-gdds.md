...
### 用例 1: Happy Path — Clean GDD set with no conflicts
...
### 用例 2: Failure Path — Conflicting rules between two GDDs
...
### 用例 3: Partial Path — Single GDD with orphaned dependency reference
...
### 用例 4: Edge Case — No GDD files found
