...
### 用例 1: Happy Path — Complete GDD, all 8 sections present
...
### 用例 2: Failure Path — Incomplete GDD (4/8 sections)
...
### 用例 3: Partial Path — 7/8 sections, minor inconsistency
...
**输入：** `/design-review design/gdd/light-manipulation.md` (with full review mode active)
