...
### 用例 1: Happy Path — All acceptance criteria met, no deviations
...
### 用例 2: Blocked Path — Acceptance criterion cannot be verified
...
### 用例 3: Blocked Path — GDD deviation detected
...
### 用例 4: Edge Case — No argument, auto-detect current story
...
### 用例 5: Director Gate — LP-CODE-REVIEW behavior across review modes
...
**输入：** `/story-done production/epics/core/story-light-pickup.md` (full mode)
